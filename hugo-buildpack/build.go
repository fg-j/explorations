...
func Build(entryResolver EntryResolver, dependencyManager DependencyManager, hugo Executable) packit.BuildFunc {
	return func(context packit.BuildContext) (packit.BuildResult, error) {
		...
		// logger.Subprocess("Installing Hugo")
		...
		// logger.Subprocess("Running 'hugo %s'", strings.Join(args, " "))
